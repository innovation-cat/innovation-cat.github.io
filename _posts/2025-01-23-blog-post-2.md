...
$$
q_{\phi}(x_{t} \mid x_{t-1}) \sim \mathcal{N}(\mu_1, \sigma_1^2I),\ \ \mu_1=\sqrt{\alpha_t}x_{t-1},\ \ \sigma_1^2=1-\alpha_t \\[10pt] q(x_{t-1} \mid x_{0})  \sim \mathcal{N}(\mu_2, \sigma_2^2I), \ \ \mu_2=\sqrt{\bar \alpha_{t-1}}x_{0},\ \sigma_2^2=1-\bar \alpha_{t-1}
$$

The product of two Gaussian distributions is itself a Gaussian distribution, 

$$
\mu_{true} = \frac{\mu_1\sigma_2^2+\mu_2\sigma_1^2}{\sigma_1^2+\sigma_2^2}=
$$
