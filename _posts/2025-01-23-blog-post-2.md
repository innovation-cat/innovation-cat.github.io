...
|---------------|-----------------|------------------|------------------------------------------------------|---------------|---------------------------|
| **Conv2d / Conv3d** | FP16 | FP16 | FP16 weights × FP16 input → **cast to FP32 for accumulation** → final result cast back to FP16 | ✅ cuDNN | FP32 accumulator prevents precision loss during reduction — safe |
| **Linear (MatMul)** | FP16 | FP16 | FP16 × FP16 → **cast to FP32 for accumulation** → cast back to FP16 | ✅ cuBLAS | Same as Conv — hardware protects accumulation — safe |
| **ReLU / GELU / SiLU** | FP16 | FP16 | No cast — computed directly in FP16 | ✅ | Activation functions are insensitive to precision — safe |
| **LayerNorm / GroupNorm** | FP16 | FP16 | FP16 input → **cast to FP32 to compute mean/variance** → normalize → cast back to FP16<br>(scale/bias params typically kept in FP32) | ✅ PyTorch AMP | Statistics must be FP32 — FP16 causes inaccurate normalization |
