...
$$
\ell(\theta; x_t, y) = \|\, y - f_{\theta}(x_t, t) \,\|^2\label{eq:20}
$$
...
1. **Correlation coefficient (or optimal linear slope)** — quantifies **task difficulty** under a linear predictability assumption.
2. **Conditional expectation** — quantifies **gradient signal strength**.
3. **Conditional variance** — quantifies **gradient stability**.
