...
-  **$ \epsilon $-prediction:** Substitute $y_t=\epsilon$ into Eq. \ref{eq:20}
   ...
   $$
   \begin{align}
   \mathbb{E}[\epsilon \mid x_t] & = \mathbb{E}(\epsilon) + \frac{\mathrm{Cov}(\epsilon, x_t)}{\mathrm{Var}(x_t)}(x_t - \mathbb{E}(x_t)) \\[10pt]
   & = b_tx_t
   \end{align}
   $$
...
-  **$ x_0 $-prediction:** Substitute $y_t=x_0$ into Eq. \ref{eq:20}
   ...
   $$
   \begin{align}
   \mathbb{E}[\epsilon \mid x_t] & = \mathbb{E}(x_0) + \frac{\mathrm{Cov}(x_0, x_t)}{\mathrm{Var}(x_t)}(x_t - \mathbb{E}(x_t)) \\[10pt]
   & = a_tx_t
   \end{align}
   $$
