...
Although the four targets — $\epsilon$-prediction, $x_0$-prediction, $v$-prediction, and score-prediction — are linearly transformable, they exhibit **uneven learning difficulty** under unit weights $w(t)\equiv 1$. Using **SNR** rather than the raw timestep $t$ reveals these imbalances clearly.
...
$$
x_t=\sqrt{\bar\alpha_t}\,x_0+\sqrt{1-\bar\alpha_t}\,\epsilon,\qquad x_0,\epsilon\sim\mathcal N(0,I),
$$
...
SNR provides schedule-invariance and aligns analysis with **denoising difficulty** and many **reweighting** designs.


---

## 2  Objective Mismatch under Unit Weights (Raw MSE)


---

### 2.1  Pearson Correlation with $x_t$


---

### 2.2  Gradient-Scale Dynamics



## 3  How Weighting Strategies Restore Balance
