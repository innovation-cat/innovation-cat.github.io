...
### <a id="section3.1.1">3.1.1 Case A: Gaussian prior for $x_0$</a>
...
- $x_0$-prediction: Since $$\mathrm{Cov}(x_0,x_t)=\mathrm{Cov}(x_0,a_t x_0 + b_t \epsilon)=a_t$$, Substitute into Eq. \ref{eq:18}
  ...
  $$
  \rho_{x_0, x_t} = \frac{\mathrm{Cov}(x_0,x_t)}{\sqrt{\mathrm{Var}(x_0)\,\mathrm{Var}(x_t)}} = \frac{a_t}{\sqrt{a_t^2+b_t^2}} = \sqrt{\frac{SNR}{{1+\text{SNR}}}}.
  $$
