...
| Format              | Bits (sign/exp/mantissa) | Dynamic range (≈) | Relative precision at 1.0 | Typical usage                                                                 |
| ------------------- | ------------------------ | ----------------- | ------------------------- | ----------------------------------------------------------------------------- |
| **FP32**            | 1/8/23                   | \~1e±38           | 2⁻²³ ≈ 1.19e−7            | Baseline; optimizer state, loss reductions, numerically sensitive operations. |
| **FP16**            | 1/5/10                   | \~6e−8 … 6.5e4    | 2⁻¹⁰ ≈ 9.77e−4            | High throughput; narrow range, requires loss scaling.                         |
| **BF16**            | 1/8/7                    | \~1e±38           | 2⁻⁷ ≈ 7.81e−3             | FP32-like range, coarser mantissa; typically no loss scaling needed.          |
| **TF32**\*          | 1/8/10                   | \~1e±38           | 2⁻¹⁰ ≈ 9.77e−4            | NVIDIA Ampere/Hopper matmul compute mode.                                     |
| **FP8 (E4M3/E5M2)** | 1/4/3 or 1/5/2           | limited           | 0.125 / 0.25              | Specialized inference/training with calibration.                              |

\*TF32 is a matmul kernel mode, not a storage format.
