...
<details style="background:#f6f8fa; border:1px solid #e5e7eb; border-radius:10px; padding:.6rem .9rem; margin:1rem 0;">
  ...
  <ul style="margin:0; padding-left:1.1rem;">
	...
	<li><a href="#section5">5. Stabilizing Diffusion Training via Network Architecture</a>
		<ul>
			<li><a href="#section5.1">5.1 Evolution of Diffusion Architectures</a>
				<ul>
					<li><a href="#section5.1.1">5.1.1 Classical U-Net </a></li>
					<li><a href="#section5.1.2">5.1.2 ADM Improvements (Attention, Class Conditioning)</a></li>
					<li><a href="#section5.1.3">5.1.3 Latent U-Net (Stable Diffusion, SDXL)</a></li>
					<li><a href="#section5.1.4">5.1.4 Transformer-based Designs (DiT, MMDiT-X, Hybrid Models)</a></li>
				</ul>
			</li>	
			<li><a href="#section5.2">5.2 Conditioning, Normalization & Tokenization</a>
				<ul>
					<li><a href="#section5.2.1">5.2.1 GroupNorm → AdaLN-Zero</a></li>
					<li><a href="#section5.2.2">5.2.2 Time / σ Embedding Strategies</a></li>
					<li><a href="#section5.2.3">5.2.3 Query-Key Normalization (e.g., SD3.5, MMDiT-X)</a></li>
					<li><a href="#section5.2.4">5.2.4 Multi-modal Token Conditioning (Cross-Attention, LoRA, Deep Fusion)</a></li>
				</ul>
			</li>
			<li><a href="#section5.3">5.3 Residual & Skip Pathway Designs</a>
				<ul>
					<li><a href="#section5.3.1">5.3.1 Classic Skip Connections in U-Net</a></li>
					<li><a href="#section5.3.2">5.3.2 Residual-in-Residual Architectures</a></li>
					<li><a href="#section5.3.3">5.3.3 Sparse Skip & Hourglass Designs (DiC)</a></li>
				</ul>
			</li>
			<li><a href="#section5.4">5.4 Transformer Architectures & Architectural Variants</a>
				<ul>
					<li><a href="#section5.4.1">5.4.1 DiT and Scaling with Transformers</a></li>
					<li><a href="#section5.4.2">5.4.2 Decoupled Design (DDT: Encoder + Decoder Separation)</a></li>
					<li><a href="#section5.4.3">5.4.3 Automated Architecture Search (DiffusionNAG)</a></li>
					<li><a href="#section5.4.4">5.4.4 Multi-resolution Networks with Time-dependent Norms</a></li>
				</ul>
			</li>
			<li><a href="#section5.5">5.5 Improved EDM as Integrative Design</a>
				<ul>
					<li><a href="#section5.5.1">5.5.1 Preconditioning + AdaLN-Zero</a></li>
					<li><a href="#section5.5.2">5.5.2 Architectural & Regularization Hybridization</a></li>
					<li><a href="#section5.5.3">5.5.3 Structurally Balanced Design for Stability</a></li>
				</ul>
			</li>
		</ul>
	</li>
