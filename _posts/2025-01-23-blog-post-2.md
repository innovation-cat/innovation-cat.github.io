...
| Format         | Bits  | Dynamic range  | Relative precision | Typical usage                                                         | Hardware support                                                                                                |
| -------------- | ------------------------ | ----------------- | ------------------------- | ----------------------------------------------- | ---------------------------------------------------- |
| **FP32**       | 1/8/23                   | Max Positive: (2-2^{-23})2^{127} \\ Min Positive Normal: 2^{-126}           | 2⁻²³ ≈ 1.19e−7            | Baseline; optimizer state, loss reductions, numerically sensitive ops | **NVIDIA**: all GPUs<br>**AMD**: all GPUs<br>**Google TPU**: all versions                                       |
