...
The loss function then simplifies to minimizing the MSE between the true velocity $v$ and the predicted $$\hat{v}$$: More practically, the loss targets the velocity:
