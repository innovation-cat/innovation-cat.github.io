...
3. **$ v $-prediction:**
   ...
   $$
   \begin{align}
   & \mathbb{E}[v \mid x_t] = a_t \, \mathbb{E}[\epsilon \mid x_t] - b_t \, \mathbb{E}[x_0 \mid x_t] \\ \Longrightarrow & \mathbb{E}[v \mid x_t] = a_t \, \mathbb{E}[\epsilon \mid x_t] - b_t \, \left( \frac{x_t}{a_t} - \frac{b_t}{a_t} \mathbb{E}[\epsilon \mid x_t] \right) \\ \Longrightarrow
...
4. **Score-prediction:**
   The score function is defined as $ s(x_t, t) = \nabla_{x_t} \log p(x_t \mid t) $,  and in the Gaussian forward process:
   $$
   s(x_t, t) = -\frac{1}{\sigma_t^2} \left( x_t - a_t \mathbb{E}[x_0 \mid x_t] \right)
              = -\frac{b_t}{\sigma_t^2} \mathbb{E}[\epsilon \mid x_t],
   $$
   where $ \sigma_t^2 = b_t^2 $ under unit-variance noise.
