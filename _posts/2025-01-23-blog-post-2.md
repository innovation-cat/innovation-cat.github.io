...
<details style="background:#f6f8fa; border:1px solid #e5e7eb; border-radius:10px; padding:.6rem .9rem; margin:1rem 0;">
  ...
  <ul style="margin:0; padding-left:1.1rem;">
	...
	<li><a href="#section3">3. An Information-Theoretic View on Training Dynamics</a>
		<ul>
			<li><a href="#section3.1">3.1 Endpoint Analysis</a></li>
			<li><a href="#section3.2">3.2 Rigorous Proof of the Mutual Information Curve Shapes</a></li>
			<li><a href="#section3.3">3.3 Summary</a></li>
		</ul>
	</li>	
...
<h1 id="section1" style="color: #1E3A8A; font-size: 27px; font-weight: bold; ">1. Preliminary</h1>
...
<h1 id="section1.1" style="color: #1E40AF; font-size: 25px; font-weight: bold; ">1.1 From Maximum likelihood to ELBO</h1>
...
<h1 id="section1.2" style="color: #1E40AF; font-size: 25px; font-weight: bold; ">1.2 From KL divergence to a mean MSE</h1>
...
<h1 id="section2" style="color: #1E3A8A; font-size: 27px; font-weight: bold; ">2. Re-parameterising the mean with different target predictor</h1>
...
<h1 id="section2.1" style="color: #1E40AF; font-size: 25px; font-weight: bold; ">2.1 $x_0$-prediction (aka sample-prediction in Diffusers)</h1>
...
<h1 id="section2.2" style="color: #1E40AF; font-size: 25px; font-weight: bold; ">2.2 $\epsilon$-prediction</h1>
...
<h1 id="section2.3" style="color: #1E40AF; font-size: 25px; font-weight: bold; ">2.3 $v$-prediction</h1>
...
<h1 id="section2.4" style="color: #1E40AF; font-size: 25px; font-weight: bold; ">2.4 Score-prediction</h1>
...
<h1 id="section3" style="color: #1E3A8A; font-size: 27px; font-weight: bold; ">3. An Information-Theoretic View on Training Dynamics</h1>
...
<h1 id="section3.1" style="color: #1E40AF; font-size: 25px; font-weight: bold;">3.1 Endpoint Analysis</h1>

Given the noisy input $$x_t = a_t x_0 + b_t \epsilon$$, we analyze the behavior of the diffusion process at its two extremes.

---

<h1 id="section3.1.1" style="color: #1D4ED8; font-size: 23px; font-weight: bold; ">3.1.1 Endpoint Values of $I(x_0, x_t)$</h1>
...
<h1 id="section3.1.2" style="color: #1D4ED8; font-size: 23px; font-weight: bold; ">3.1.2 Endpoint Values of $I(\epsilon, x_t)$</h1>
...
<h1 id="section3.1.3" style="color: #1D4ED8; font-size: 23px; font-weight: bold; ">3.1.3 Endpoint Values of $I(v, x_t)$</h1>
...
<h1 id="section3.1.4" style="color: #1D4ED8; font-size: 23px; font-weight: bold; ">3.1.4 Endpoint Values of $I(v, x_t)$</h1>
...
<h1 id="section3.2" style="color: #1E40AF; font-size: 25px; font-weight: bold; ">3.2 Rigorous Proof of the Mutual Information Curve Shapes</h1>
...
<h1 id="section3.2.1" style="color: #1D4ED8; font-size: 23px; font-weight: bold; ">3.2.1 $I(x_0; x_t)$ is Monotonically Increasing with SNR</h1>
...
<h1 id="section3.2.2" style="color: #1D4ED8; font-size: 23px; font-weight: bold; ">3.2.2 $I(\epsilon; x_t)$ is Monotonically Decreasing with SNR</h1>
...
<h1 id="section3.2.3" style="color: #1D4ED8; font-size: 23px; font-weight: bold; ">3.2.3 The Shape of $I(v; x_t)$ is Arch-Shaped</h1>
...
<h1 id="section3.3" style="color: #1E40AF; font-size: 25px; font-weight: bold; ">3.3 Summary </h1>
...
<h1 id="section4" style="color: #1E3A8A; font-size: 28px; font-weight: bold; ">4. Stabilizing Diffusion Training via Optimization & Objective Design</h1>
