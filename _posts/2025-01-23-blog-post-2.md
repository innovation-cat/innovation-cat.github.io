...
- $\epsilon$-prediction: $\rho_{\epsilon, x_t} = \dfrac{1}{\sqrt{1+\mathrm{SNR}}}$ — **strong at low SNR**, weak at high SNR.  
- $x_0$-prediction: $\rho_{x_0, x_t} = \sqrt{\dfrac{\mathrm{SNR}}{1+\mathrm{SNR}}}$ — **strong at high SNR**, weak at low SNR.  
- $v$-prediction: $\rho_{v, x_t} = 0$ — orthogonal to $x_t$ for all SNR.  
...
![Correlation vs SNR](/assets/img/diffusion/correlation_vs_snr_fusion.png)
...
![Conditional mean coefficient vs SNR](/assets/img/diffusion/condmean_vs_snr_fusion.png)
...
![Conditional variance vs SNR](/assets/img/diffusion/condvar_vs_snr_fusion.png)
