...
$$
\mathbb{E}(y_t \mid x_t) = \mathbb{E}(y_t) + \frac{(y_t, x_t)}{(x_t)}\left( x_t - \mathbb{E}(x_t) \right)\label{eq:20}
$$
...
-  **$ \epsilon $-prediction:** Substitute $y_t=\epsilon$ into Eq. \ref{eq:20}
   ...
   $$
   \begin{align}
   \mathbb{E}[\epsilon \mid x_t] & = \mathbb{E}(\epsilon) + \frac{{Cov}(\epsilon, x_t)}{{Var}(x_t)}(x_t - \mathbb{E}(x_t)) \\[10pt]
   & = b_tx_t
   \end{align}
   $$
...
-  **$ x_0 $-prediction:** Substitute $y_t=x_0$ into Eq. \ref{eq:20}
   ...
   $$
   \begin{align}
   \mathbb{E}[\epsilon \mid x_t] & = \mathbb{E}(x_0) + \frac{{Cov}(x_0, x_t)}{{Var}(x_t)}(x_t - \mathbb{E}(x_t)) \\[10pt]
   & = a_tx_t
   \end{align}
   $$
