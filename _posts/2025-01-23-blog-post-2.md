...
\right] \\[10pt]
& = \mathbb{E}_{\sigma\sim p(\sigma)}\ \mathbb{E}_{x_0,\epsilon}\left[
\lambda(\sigma)\ \big\|\,  c_{\text{out}}(\sigma)f_{\theta}(c_{\text{in}}(\sigma) x(\sigma), c_{\text{noise}}(\sigma)) + c_{\text{skip}}(\sigma)\,x(\sigma)-T(\sigma)\,\big\|_2^2
\right] \\[10pt]
...
$$
\boxed{\;\lambda(\sigma)=\frac{1}{c_{\text{out}}(\sigma)^2}\;}
$$
