		...
		<ul>
			<li><a href="#section2.1">2.1 Motivation</a>
				<ul>
					...
					<li><a href="#section2.1.2">2.1.2 Curvature in Flow Matching Trajectories</a></li>
					<li><a href="#section2.1.2">2.1.3 Why Path Linearization Helps</a></li>
				</ul>
			</li>
		</ul>
	</li>
...
### <a id="section2.1.2">2.1.2 Curvature in Flow Matching Trajectories</a>
...
### <a id="section2.1.3">2.1.3 Why Path Linearization Helps</a>
