...
Flow Matching (FM) defines a *straight path* between a base distribution $p_0$ (e.g., Gaussian noise) and the data distribution $p_1$. In training, the teacher velocity field corresponds to the tangent of this straight line:
