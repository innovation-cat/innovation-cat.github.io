...
<h1 id="section1" style="color: #1E3A8A; font-size: 28px; font-weight: bold; text-decoration: underline;">1. The unified forward process: From discrete perspective</h1>
...
<h1 id="section3" style="color: #1E3A8A; font-size: 28px; font-weight: bold; text-decoration: underline;">3. The unified Reverse Process: From continuous perspective</h1>
