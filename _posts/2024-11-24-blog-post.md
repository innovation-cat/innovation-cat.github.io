...
<details style="background:#f6f8fa; border:1px solid #e5e7eb; border-radius:10px; padding:.6rem .9rem; margin:1rem 0;">
  ...
  <ul style="margin:0; padding-left:1.1rem;">
    <li><a href="#section1">1. Forward Process in Discrete Time: A Unified Formulation</a>
	  <ul>
        <li><a href="#section1.1">1.1 Variance Preserving Formulation</a></li>
        <li><a href="#section1.2">1.2 Variance Exploding Formulation</a></li>
      </ul>
	</li>
    <li><a href="#section2">2. Bridging Discrete and Continuous: Deriving the SDE Form</a></li>
    <li><a href="#section3">3. Reverse Dynamics: Reverse-Time SDE and PF-ODE</a>
	  <ul>
        <li><a href="#section3.1">3.1 Verification: DDPM Reverse Process</a></li>
		<li><a href="#section3.2">3.2 Verification: NCSN Reverse Process</a></li>
		<li><a href="#section3.3">3.3 Verification: DDIM Reverse Process</a></li>
      </ul>
	</li>
    <li><a href="#section4">4. Conclusion: The Value of a Unified Perspective</a></li>
...
<h1 id="section1.2" style="color: #1E40AF; font-size: 25px; font-weight: bold; text-decoration: underline;">1.1 Variance Exploding Formulation</h1>
...
<h1 id="section3.1" style="color: #1E40AF; font-size: 25px; font-weight: bold; text-decoration: underline;">3.1 Verification: DDPM Reverse Process</h1>
...
<h1 id="section3.2" style="color: #1E40AF; font-size: 25px; font-weight: bold; text-decoration: underline;">3.2 Verification: NCSN Reverse Process</h1>
...
<h1 id="section3.3" style="color: #1E40AF; font-size: 25px; font-weight: bold; text-decoration: underline;">3.3 Verification: DDIM Reverse Process</h1>
...
Let $s=t-h$ with $h\downarrow 0$. Write $\bar\alpha_t=\bar\alpha(t)$. Using

$$
\frac{\bar\alpha(s)}{\bar\alpha(t)} = \exp\!\Big(\!\int_{t}^{t-h}\!\!\beta(u)\,du\Big)
= e^{-\int_{t-h}^{t}\beta} \;\approx\; 1+\beta(t)h,
$$


Rewrite the DDIM step as

$$
x_s
=\sqrt{\tfrac{\bar\alpha(s)}{\bar\alpha(t)}}\,x_t
+\Big(\sqrt{1-\bar\alpha(s)}-\sqrt{\tfrac{\bar\alpha(s)}{\bar\alpha(t)}}\,\sqrt{1-\bar\alpha_t}\Big)\varepsilon_\theta(x_t,t).
$$
