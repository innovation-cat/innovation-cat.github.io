...
<details style="background:#f6f8fa; border:1px solid #e5e7eb; border-radius:10px; padding:.6rem .9rem; margin:1rem 0;">
  ...
  <ul style="margin:0; padding-left:1.1rem;">
    ...
    <li><a href="#section3">3. Reverse Dynamics: Reverse-Time SDE and PF-ODE</a>
	  <ul>
        <li><a href="#section3.1">3.1 Verify DDPM Reverse Process as Reverse SDE Family</a></li>
		<li><a href="#section3.2">3.2 Verify NCSN Reverse Process as Reverse SDE Family</a></li>
		<li><a href="#section3.3">3.3 Verify DDIM Reverse Process as PF-ODE</a></li>
      </ul>
	</li>
