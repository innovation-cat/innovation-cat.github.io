...
<h1 id="section3.3" style="color: #1E40AF; font-size: 25px; font-weight: bold; text-decoration: underline;">3.2 Verification: DDIM Reverse Process</h1>

Recall DDIM [^ddim] one-step sampling formulation, from $t$ to an earlier $s < t$.

$$
x_s = \sqrt{\bar\alpha_s}\hat x_0 + \sqrt{1-\bar\alpha_s-\eta}\epsion(x_t, t) + \eta z,\quad z \sim \mathcal{N}(0,I)
$$ 

where 

$$
\hat x_0 = \frac{x_t - \sqrt{1-\bar\alpha_t}\epsion(x_t, t)}{\sqrt{\bar\alpha_t}}
$$
