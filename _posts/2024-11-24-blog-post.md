...
<details style="background:#f6f8fa; border:1px solid #e5e7eb; border-radius:10px; padding:.6rem .9rem; margin:1rem 0;">
  ...
  <ul style="margin:0; padding-left:1.1rem;">
    <li><a href="#section1">1. The unified forward process</a></li>
    <li><a href="#section2">2. From discrete perspective to continuous perspective</a></li>
    <li><a href="#section3">3. The unified Reverse Process</a></li>
...
<h1 id="section1" style="color: #1E3A8A; font-size: 28px; font-weight: bold; text-decoration: underline;">1. The unified forward process: from a discrete perspective</h1>
...
<h1 id="section2" style="color: #1E3A8A; font-size: 28px; font-weight: bold; text-decoration: underline;">2. From discrete perspective to continuous perspective</h1>
...
<h1 id="section3" style="color: #1E3A8A; font-size: 28px; font-weight: bold; text-decoration: underline;">3. Reverse Process</h1>
