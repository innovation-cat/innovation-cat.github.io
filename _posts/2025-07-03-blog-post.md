...
$$
\mathrm{d}x_t=\Big[f(t)x_t - g^2(t)\nabla_{x_t}\log p_t(x_t) - g^2(t)\nabla_{x_t}\log p_t(c|x_t) \Big]\mathrm{d}t  + g(t)\,\mathrm{d}\bar w_t,
...
This is why it is called classifier guidance. Substituting into (3) gives the **classifier-guided reverse SDE**:


$$
\mathrm{d}x_t=\Big[f(t)x_t - g^2(t)\nabla_{x_t}\log p_t(x_t) - s(t)\nabla_{x_t}\log p_\phi(c\mid x_t,t) \Big]\mathrm{d}t  + g(t)\,\mathrm{d}\bar w_t,
