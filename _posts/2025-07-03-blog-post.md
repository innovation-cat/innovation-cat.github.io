...
Prompt-to-Prompt [^p2p] was a pioneering work that demonstrated how to perform complex semantic edits by directly manipulating cross-attention maps. The core idea is to use a pair of prompts: a source prompt and a target prompt.
