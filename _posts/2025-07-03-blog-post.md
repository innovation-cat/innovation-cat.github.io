...
$$
g_{\text{total}}(x_t, t) \;=\; g_{\text{uncond}}(x_t, t) \;+\; w\,g_{\text{guide}}(x_t, t),
...
$$
\begin{align}
{\epsilon}_{\text{total}} & = {\epsilon}_{\text{uncond}} + w(t)\,{\epsilon}_{\text{guide}} = {\epsilon}_{\text{uncond}} + w(t)\,\left( {\epsilon}_{\text{cond}} - {\epsilon}_{\text{uncond}} \right) \\[10pt]
& =\epsilon_\theta(x_t,\varnothing,t) + w(t)\,\left(\epsilon_\theta(x_t,c,t)\;-\epsilon_\theta(x_t,\varnothing,t) \right) \\[10pt]
