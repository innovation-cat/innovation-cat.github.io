...
<h1 id="section2.4" style="color: #1E40AF; font-size: 25px; font-weight: bold; text-decoration: underline;">2.4 CFG Combining Multiple Conditions</h1>

In practice, there is usually more than one condition, which may include both positive and negative conditions. In this section, we discuss the issue of guided generation with multiple conditions, where these multiple conditions can be independent of each other, or they may be interrelated or even conflicting.
