...
<table border="1" cellpadding="10" cellspacing="0" style="border-collapse: collapse; width: 100%; text-align: center;">
  <thead>
    <tr>
      ...
      <th style="text-align: center; vertical-align: middle;">Editing Goal</th>
      <th style="text-align: center; vertical-align: middle;">Attention Map Modification (Formula / Operation)</th>
      <th style="text-align: center; vertical-align: middle;">Concrete Steps</th>
      <th style="text-align: center; vertical-align: middle;">Semantic & Visual Interpretation</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      ...
      <td style="text-align: center; vertical-align: middle;">Preserve layout, replace semantic entity only</td>
      <td style="text-align: center; vertical-align: middle;">$$\tilde{A}_{:,col(dog)} = A_t[:,col(cat)]$$<br>Other columns unchanged</td>
      <td style="text-align: center; vertical-align: middle;">① Align source/target tokens<br>② Locate replacement position<br>③ Replace column<br>④ Normalize</td>
      <td style="text-align: center; vertical-align: middle;">Map the attention region of “dog” to the semantics of “cat”, changing shape to cat while preserving position</td>
    </tr>
    <tr>
      ...
      <td style="text-align: center; vertical-align: middle;">Add modifier without altering structure</td>
      <td style="text-align: center; vertical-align: middle;">$$\tilde{A} = [A_s[:,a], A_t[:,brown], A_s[:,dog]]$$<br>Re-normalize after insertion</td>
      <td style="text-align: center; vertical-align: middle;">① Identify insertion position<br>② Insert “brown” column from target map<br>③ Apply Softmax normalization</td>
      <td style="text-align: center; vertical-align: middle;">The new attention column resembles the noun column, altering color/texture</td>
    </tr>
    <tr>
      ...
      <td style="text-align: center; vertical-align: middle;">Amplify semantic intensity (e.g., cuteness)</td>
      <td style="text-align: center; vertical-align: middle;">$$\tilde{A}_{:,cute}=(1+\lambda)A_s[:,cute]$$<br>$$\tilde{A}_{:,very}=\eta A_s[:,cute]$$</td>
      <td style="text-align: center; vertical-align: middle;">① Insert “very” column<br>② Amplify “cute” column strength<br>③ Normalize</td>
      <td style="text-align: center; vertical-align: middle;">“very” does not create a new region; it only amplifies the modifier’s influence, making visual features more pronounced</td>
    </tr>
    <tr>
      ...
      <td style="text-align: center; vertical-align: middle;">Remove unnecessary modifier</td>
      <td style="text-align: center; vertical-align: middle;">Delete “brown” column: $$\tilde{A}=[A_s[:,a],A_s[:,dog]]$$</td>
      <td style="text-align: center; vertical-align: middle;">① Remove corresponding column<br>② Apply Softmax normalization</td>
      <td style="text-align: center; vertical-align: middle;">Eliminate color bias, allowing generated color to revert to model prior</td>
    </tr>
    <tr>
      ...
      <td style="text-align: center; vertical-align: middle;">Amplify local semantic influence</td>
      <td style="text-align: center; vertical-align: middle;">$$\tilde{A}_{:,cute}=(1+\lambda)A_s[:,cute]$$</td>
      <td style="text-align: center; vertical-align: middle;">① Identify target token<br>② Amplify attention weight<br>③ Normalize</td>
      <td style="text-align: center; vertical-align: middle;">Increase the influence of a token during generation (e.g., cuter expression, brighter lighting)</td>
    </tr>
    <tr>
      ...
      <td style="text-align: center; vertical-align: middle;">Reduce modifier impact</td>
      <td style="text-align: center; vertical-align: middle;">$$\tilde{A}_{:,cute}=(1-\lambda)A_s[:,cute]$$</td>
      <td style="text-align: center; vertical-align: middle;">① Identify weakening token<br>② Attenuate column weight<br>③ Normalize</td>
      <td style="text-align: center; vertical-align: middle;">Make semantics milder and visuals more natural</td>
    </tr>
    <tr>
      <td style="text-align: center; vertical-align: middle;"><strong>7</strong></td>
      ...
      <td style="text-align: center; vertical-align: middle;">Adjust modifier order (subtle semantic shift)</td>
      <td style="text-align: center; vertical-align: middle;">Reorder columns: $$\tilde{A}=[A_s[:,a],A_s[:,big],A_s[:,red],A_s[:,dog]]$$</td>
      <td style="text-align: center; vertical-align: middle;">① Reorder columns according to new sequence<br>② Keep column values unchanged</td>
      <td style="text-align: center; vertical-align: middle;">Changing token order slightly affects interaction weights (e.g., “large red” vs. “red large object”)</td>
    </tr>
    <tr>
      <td style="text-align: center; vertical-align: middle;"><strong>8</strong></td>
      <td style="text-align: center; vertical-align: middle;"><strong>Multi-Object Replacement</strong></td>
      <td style="text-align: center; vertical-align: middle;">“a dog and a cat” → “a dog and a <strong>bird</strong>”</td>
      <td style="text-align: center; vertical-align: middle;">Partially replace specific objects</td>
      <td style="text-align: center; vertical-align: middle;">$$\tilde{A}=(1-M)\odot A_s+M\odot A_t$$</td>
      <td style="text-align: center; vertical-align: middle;">① Align objects<br>② Replace “cat” column with “bird” column<br>③ Optionally use mask \(M\) to restrict region</td>
      <td style="text-align: center; vertical-align: middle;">Modify attention only in the cat region, preserving dog and background</td>
    </tr>
    <tr>
      ...
      <td style="text-align: center; vertical-align: middle;">Inject stylistic features</td>
      <td style="text-align: center; vertical-align: middle;">High-level blending: $$\tilde{A}^{(l)}=(1-\alpha)A_s^{(l)}+\alpha A_t^{(l)}$$<br>(\(\alpha≈0.2\))</td>
      <td style="text-align: center; vertical-align: middle;">① Insert style column at high layers<br>② Blend with small weight<br>③ Affects only later layers</td>
      <td style="text-align: center; vertical-align: middle;">Influences high-level texture and color tone without altering shape or structure</td>
    </tr>
  </tbody>
</table>
