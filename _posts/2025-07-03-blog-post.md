...
$$
{\epsilon}_{\text{total}}  = \underbrace{\epsilon_\theta(x_t, t, \varnothing)}_{\text{uncondition}} + w(t)\cdot \underbrace{\overbrace{\epsilon_\theta(x_t, t, c)}^{\text{condition}} - \overbrace{\epsilon_\theta(x_t, t, \varnothing)}^{\text{uncondition}}}_{\text{guide direction}}
$$
