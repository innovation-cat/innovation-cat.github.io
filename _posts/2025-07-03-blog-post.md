...
Let the classifier output logits $\ell(x_t,t)\in\mathbb{R}^K$ for $K$ classes. 

$$
\ell(x_t,t) = [\ell_1(x_t,t), \ell_2(x_t,t), \dots, \ell_K(x_t,t)]
$$
...
$$
\nabla_{x_t}\log p_\phi(c\mid x_t)
=\nabla_{x_t}\ell_y(x_t,t)

* \sum_k p_\phi(k\mid x_t,t),\nabla_{x_t}\ell_k(x_t,t).
  \tag{9}
  ]
