...
This differential gradient defines a **force field** that points from low-density (less relevant) regions of $p(x)$ toward high-density regions of $p(x\mid c)$.

Intuitively, this direction drives the denoising trajectory *back toward the conditional manifold* whenever the sample drifts into low-probability zones—thus suppressing artifacts and improving semantic fidelity.
