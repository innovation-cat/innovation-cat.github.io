...
$$
{\epsilon}_{\text{total}}  = \underbrace{\epsilon_\theta(x_t, t, \varnothing)}_{\text{uncondition}} + w(t)\cdot \underbrace{\overbrace{\epsilon_\theta(x_t, t, c)}_{\text{condition}} - \overbrace{\epsilon_\theta(x_t, t, \varnothing)}_{\text{uncondition}}}_{\text{guide direction}}
$$
