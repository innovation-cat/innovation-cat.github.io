...
& \mathbb E(x_t|x_0) = \mathbb E(x_0|x_0) + \int_0^tf(s)*\mathbb E (x_s|x_0)*ds + \int_0^tg(s)*\mathbb E(dw_s|x_0)\label{eq:6} 
\end{align}
$$
...
& dx_t^2=(2f(t)x_t^2+g^2(t))dt+g(t)dw_t\label{eq:8}
\end{align}
$$
...
& \mathbb E(x_t^2|x_0) = \mathbb E(x_0^2|x_0) + \int_0^t(2*f(s)*\mathbb E (x_s^2|x_0)+g^2(s))ds\label{eq:9} 
\end{align}
$$
...
$$
m_2'(x_t) =  2f(t)m_2(x_t)+g^2(t)\label{eq:10}
$$
