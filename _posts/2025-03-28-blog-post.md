...
depthwise-separable convolution [1, 2] decomposes a standard convolution into two lightweight components:  
- **depthwise convolution**: that applies a single spatial filter per input channel, and  
