...
<table border="1" cellpadding="12" cellspacing="0" style="border-collapse: collapse; font-family: Arial, sans-serif; width: 100%; table-layout: fixed;">
  <thead>
    <tr style="background-color: #f8f9fa;">
      <th style="border: 1px solid #ddd; text-align: center; vertical-align: middle; padding: 12px;">Category</th>
      <th style="border: 1px solid #ddd; text-align: center; vertical-align: middle; padding: 12px;">Technique</th>
      <th style="border: 1px solid #ddd; text-align: center; vertical-align: middle; padding: 12px;">Training</th>
      <th style="border: 1px solid #ddd; text-align: center; vertical-align: middle; padding: 12px;">Inference</th>
      <th style="border: 1px solid #ddd; text-align: center; vertical-align: middle; padding: 12px;">Purpose / Effect</th>
    </tr>
  </thead>
  <tbody>
    <tr>
