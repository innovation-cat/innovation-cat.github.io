...
<table border="1" cellpadding="12" cellspacing="0"
  ...
  <thead>
    <tr style="background-color: #f8f9fa;">
      <th style="width: 15%; border: 1px solid #ddd; text-align: center; vertical-align: middle; padding: 12px;">Category</th>
      <th style="width: 20%; border: 1px solid #ddd; text-align: center; vertical-align: middle; padding: 12px;">Technique</th>
      <th style="width: 10%; border: 1px solid #ddd; text-align: center; vertical-align: middle; padding: 12px;">Training</th>
      <th style="width: 10%; border: 1px solid #ddd; text-align: center; vertical-align: middle; padding: 12px;">Inference</th>
      <th style="width: 45%; border: 1px solid #ddd; text-align: center; vertical-align: middle; padding: 12px;">Purpose / Effect</th>
    </tr>
  </thead>
  <tbody>
    <tr>
...
<h1 id="section5.1" style="color: #1E3A8A; font-size: 28px; font-weight: bold; text-decoration: underline;">5.1 Training-time Memory Efficiency</h1>


<h1 id="section5.1.1" style="color: #1E3A8A; font-size: 28px; font-weight: bold; text-decoration: underline;">5.1.1 Gradient Checkpointing</h1>
