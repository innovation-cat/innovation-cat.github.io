...
The attention scores are defined as $S = \tfrac{1}{\sqrt{d}} Q K^\top$. Differentiating with respect to $Q$ and $K$ gives

$$
d_Q = \frac{1}{\sqrt{d}} dS K, \qquad
d_K = \frac{1}{\sqrt{d}} dS^\top Q.
$$
