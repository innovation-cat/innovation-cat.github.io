...
## <span style="color:#3498DB;">Traditional Gradient Calculation: full backward chain from $dO$</span>
...
- **Step 3: Gradients $d_Q$ & $d_K$  through the scaled dot-product scores.** The attention scores are defined as $S = \tfrac{1}{\sqrt{d}} Q \cdot K^\top$. Differentiating with respect to $Q$ and $K$ gives
