  ...
  <ul style="margin:0; padding-left:1.1rem;">
	...
	<li><a href="#section5">5. Mixed Precision Training</a>
		<ul>
		  ...
		  <li><a href="#section5.5">5.5 Memory Budget with Mixed Precision Training</a>
				<ul>
					<li><a href="#section5.5.1">5.5.1 Pure FP32 Training</a></li>
					<li><a href="#section5.5.2">5.5.2 Mixed Precision Training (BF16/FP16)</a></li>
					<li><a href="#section5.5.3">5.5.3 Key Takeaways and summary</a></li>
				</ul>
		  </li>
		</ul>
	</li>
