...
## <span style="color:#3498DB;">Global-norm clipping: the baseline</span>
...
- Preserves the overall gradient direction.
- Simple and effective for most models (default in PyTorch and TensorFlow).

**Cons:**

- A single large gradient in one layer can cause all gradients to be scaled down excessively.


## <span style="color:#3498DB;">Per-layer and unit-wise clipping</span>
...
- More flexible; prevents one large layer from dominating others.
- Useful for networks with heterogeneous gradient scales.

⚠️ **Cons:**

- Distorts the global direction of the gradient vector.
- Can make optimization slightly less consistent across layers.

## <span style="color:#3498DB;">Adaptive, parameter-relative clipping</span>
...
## <span style="color:#3498DB;">Pure gradient normalization</span>
...
## <span style="color:#3498DB;">Takeaways and Summary</span>
...
## <span style="color:#3498DB;">Standard EMA</span>
...
## <span style="color:#3498DB;">Post-hoc EMA</span>
...
## <span style="color:#3498DB;">Floating-Point Formats in Practice</span>
...
## <span style="color:#3498DB;">Reference Table: Precision Handling of Operators</span>
...
## <span style="color:#3498DB;">Loss Scaling and Unscaling in Mixed-Precision Training</span>
