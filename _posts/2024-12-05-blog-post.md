...
<h1 style="color: #3498DB; font-size: 21px; font-weight: bold; ">Global-norm clipping: the baseline</h1>
...
<h1 style="color: #3498DB; font-size: 21px; font-weight: bold; ">Per-layer and unit-wise clipping</h1>
...
<h1 style="color: #3498DB; font-size: 21px; font-weight: bold; ">Value Clipping (Elementwise Clipping)</h1>
...
<h1 style="color: #3498DB; font-size: 21px; font-weight: bold; ">Adaptive Gradient Clipping (AGC)</h1>
