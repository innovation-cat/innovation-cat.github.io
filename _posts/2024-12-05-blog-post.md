...
where $y_t$ is the chosen target, and $x_t = a_t x_0 + b_t \epsilon$ is the noisy input. The key question becomes: **how much information does $x_t$ contain about $y_t$ at different noise levels?** This can be captured directly by the **Mutual Information (MI)**, denoted as $I(y_t; x_t)$. It measures the reduction in uncertainty about the target $y_t$ after observing the input $x_t$.  
