...
<ul class="hanging-list">
    ...
    <li><strong>Noise schedule:</strong> defines how SNR evolves with (t); weighting must complement its curvature.</li>
    <li><strong>Sampling distribution:</strong> controls how often each SNR region is visited during training.</li>
	<li><strong>Data characteristics:</strong> natural images favor detail-preserving weights; semantic data prefer structure-oriented ones.</li>
	<li><strong>Optimization setup:</strong> the optimizer and precision settings influence how gradient scaling interacts with (w(t)).</li>
</ul>
