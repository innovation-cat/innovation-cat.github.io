...
<h1 id="section6" style="color: #7F8C8D; font-size: 20px; font-weight: bold; text-decoration: underline;">Perceptual Weighting in Latent Space</h1>

---

<h1 id="section2.3.3" style="color: #7F8C8D; font-size: 20px; font-weight: bold; text-decoration: underline;">2.3.3 Evolution to SDXL: Refining the Latent U-Net Formula</h1>
