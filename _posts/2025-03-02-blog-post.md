...
<h1 id="section2.3.1" style="color: #7F8C8D; font-size: 22px; font-weight: bold; text-decoration: underline;">2.3.1 The Core Idea: Diffusion in a Compressed Latent Space</h1>
...
<h1 id="section2.3.2" style="color: #7F8C8D; font-size: 22px; font-weight: bold; text-decoration: underline;">2.3.2 Architectural Breakdown of the Latent U-Net</h1>
...
<h1 id="section2.3.2.1" style="color: #7F8C8D; font-size: 20px; font-weight: bold; text-decoration: underline;">Conditioning Paradigm Shift: From Global AdaGN to Localized Cross-Attention</h1>
...
---
<h1 id="section2.3.2.2" style="color: #7F8C8D; font-size: 20px; font-weight: bold; text-decoration: underline;">The Division of Labor: Self-Attention vs. Cross-Attention</h1>
...
<h1 id="section2.3.2.3" style="color: #7F8C8D; font-size: 20px; font-weight: bold; text-decoration: underline;">Adapting the Training Objective for Latent Space: $\epsilon$-prediction vs. $v$-prediction</h1>
...
<h1 id="section2.3.2.4" style="color: #7F8C8D; font-size: 22px; font-weight: bold; text-decoration: underline;">2.3.2.4 Perceptual Weighting in Latent Space</h1>

---

<h1 id="section2.3.3" style="color: #7F8C8D; font-size: 22px; font-weight: bold; text-decoration: underline;">2.3.3 Evolution to SDXL: Refining the Latent U-Net Formula</h1>
