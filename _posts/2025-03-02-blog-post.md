...
<div class="qa-block">
  ...
  <ul class="hanging-list">
    <li><strong>&emsp;&emsp;Ubiquity:</strong> every residual block already contains a normalization step, so conditioning can permeate the entire network.</li>
    ...
    <li><strong>&emsp;&emsp;Lightweight but global influence:</strong> a small MLP projecting a condition vector can control feature distributions across all layers without altering the convolutional or attention weights directly.</li>
  </ul>
