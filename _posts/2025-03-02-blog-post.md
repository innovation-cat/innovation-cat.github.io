...
<h1 style="color: #212121; font-size: 21px; font-weight: bold; ">2️⃣ A Substantially Larger and More Robust U-Net Backbone</h1>
...
<h1 style="color: #212121; font-size: 21px; font-weight: bold; ">3️⃣ The Dual Text Encoder: A Hybrid Approach to Prompt Understanding</h1>
...
<h1 style="color: #212121; font-size: 21px; font-weight: bold; ">4️⃣ Micro-Conditioning for Resolution and Cropping Robustness</h1>
...
<h1 style="color: #212121; font-size: 21px; font-weight: bold; ">1️⃣ Temporal Layers for Consistency</h1>
...
<h1 style="color: #212121; font-size: 21px; font-weight: bold; ">2️⃣ Conditioning on Motion</h1>
...
<h1 style="color: #212121; font-size: 21px; font-weight: bold; ">1️⃣ Diffusion on 3D Gaussian Splatting Parameters</h1>
...
The different between Pre-LN and Post-LN lies in **LayerNorm Jacobian** and how it sits in the residual pathway. For an input vector $x =[x_1, x_2, \dots, x_D]^\top \,\in\,\mathbb{R}^D$, LN computes:
...
\sigma^2 \;=\; \tfrac{1}{D}\|\tilde x\|_2^2,\quad
\sigma \;=\; \sqrt{\sigma^2+\varepsilon},
$$

$y=[y_1, y_2, \dots, y_D]^\top \,\in\,\mathbb{R}^D$, differentiate $y=\tilde x/\sigma$, the **Jacobian** of LN with respect to $x$ is
...
$$
\|g_0\|_2 \;\approx\; \Big(\prod_{\ell=1}^L \|I+F'_\ell\|_2\Big)
\Big(\prod_{\ell=1}^L \frac{1}{\sigma_\ell}\Big) \Big( \prod_{\ell=1}^L \|g_L\|_2 \Big).
$$
