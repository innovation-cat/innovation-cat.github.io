...
### <a id="section2.3.2.4"> **Adapting the Training Objective for Latent Space: $\epsilon$-prediction vs. $v$-prediction** 
...
<h1 style="font-size: 48px;", id="section6">6. References</h1>
