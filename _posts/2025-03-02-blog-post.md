...
### <a id="section2.3.2">2.3.2 Architectural Breakdown of the Latent U-Net</a>
...
### <a id="section2.3.2.1"> **Conditioning Paradigm Shift: From Global AdaGN to Localized Cross-Attention.** 
...
### <a id="section2.3.2.2"> **The Division of Labor: Self-Attention vs. Cross-Attention** 
...
### <a id="section2.3.2.3"> **Adapting the Training Objective for Latent Space: $\epsilon$-prediction vs. $v$-prediction** 
...
<h1 id="section6" style="color: #2C3E50; font-size: 18px; font-weight: bold; text-decoration: underline;">Perceptual Weighting in Latent Space</h1>

<h1 id="section6" style="color: #3498DB; font-size: 20px; font-weight: bold; text-decoration: underline;">Perceptual Weighting in Latent Space</h1>
