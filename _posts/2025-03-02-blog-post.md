...
$$
\mu \;=\; \tfrac{1}{m}\mathbf{1}^\top x,\qquad
\tilde x \;=\; x-\mu\mathbf{1},\qquad
\sigma^2 \;=\; \tfrac{1}{m}\|\tilde x\|_2^2,\qquad
...
$$
J(x)\;=\;\frac{1}{\sigma}!\left(H-\frac{1}{m}yy^\top\right)
\;=\;\frac{1}{\sigma}!\left(I-\frac{1}{m}\mathbf{1}\mathbf{1}^\top-\frac{1}{m}yy^\top\right)
$$

Component form (useful for implementation checks):

$$
\frac{\partial y_i}{\partial x_j}=\frac{1}{\sigma}\left(\delta_{ij}-\frac{1}{m}-\frac{1}{m}y_i y_j\right)
$$
