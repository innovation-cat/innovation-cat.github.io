...
The different between Pre-LN and Post-LN lies in **LayerNorm Jacobian** and how it sits in the residual pathway. For an input vector (x\in\mathbb{R}^m), LN computes:
