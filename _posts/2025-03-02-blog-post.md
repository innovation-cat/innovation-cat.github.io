...
$\mathbf{y}=[y_1, y_2, \dots, y_D]^\top \,\in\,\mathbb{R}^D$, differentiate $\mathbf{y}=\tilde \mathbf{x}/\sigma$, the **Jacobian** of LN (denoted as $J_{\rm LN}$) with respect to $x$ is

$$
J_{\rm LN}\;=\;\frac{1}{\sigma}\left(H-\frac{1}{D}yy^\top\right)
