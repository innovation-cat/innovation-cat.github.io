...
$$
J_{\rm LN} \cdot \mathbf{1}=\mathbf{0}\quad(\text{shift invariance}),\qquad J_{\rm LN} \cdot y=\mathbf{0}\quad(\text{scale invariance}).
$$
...
$$
\begin{align}
\frac{\partial \mathcal{L}}{\partial x_l} & = \frac{\partial \mathcal{L}}{\partial x_{l+1}} \cdot \frac{\partial x_{l+1}}{\partial x_{l}} = J_{\rm LN}(x_l + f(x_l)) \cdot (I+J_{f}(x_l)) \cdot  g_{l+1} \\[10pt]
...
\Big(\prod_{\ell=1}^L \frac{1}{\sigma_\ell}\Big) \|g_L\|_2 \,  
$$
