...
<h1 id="section2.3.2.1" style="color: #64748B; font-size: 20px; font-weight: bold; text-decoration: underline;">👉 Conditioning Paradigm Shift: From Global AdaGN to Localized Cross-Attention</h1>
...
---
<h1 id="section2.3.2.2" style="color: #64748B; font-size: 20px; font-weight: bold; text-decoration: underline;">👉 The Division of Labor: Self-Attention vs. Cross-Attention</h1>
...
<h1 id="section2.3.2.3" style="color: #3498DB; font-size: 20px; font-weight: bold; text-decoration: underline;">👉 Adapting the Training Objective for Latent Space: $\epsilon$-prediction vs. $v$-prediction</h1>
...
<h1 id="section2.3.2.4" style="color: #3498DB; font-size: 22px; font-weight: bold;">
...
<h1 id="section2.3.3" style="color: #2C3E50; font-size: 22px; font-weight: bold; text-decoration: underline;">2.3.3 Evolution to SDXL: Refining the Latent U-Net Formula</h1>

While Stable Diffusion models 1.x and 2.x established the power of the Latent Diffusion paradigm, Stable Diffusion XL (SDXL) represents a significant architectural leap forward. It is not merely a larger model but a systematically re-engineered system designed to address the core limitations of its predecessors, including native resolution, prompt adherence, and aesthetic quality. The following sections provide a detailed technical breakdown of the key architectural innovations in SDXL.

---


<h1 id="section2.3.3.1" style="color: #3498DB; font-size: 22px; font-weight: bold;">
...
<h1 id="section2.3.3.2" style="color: #3498DB; font-size: 22px; font-weight: bold;">
...
<h1 id="section2.3.3.3" style="color: #3498DB; font-size: 22px; font-weight: bold;">
...
<h1 id="section2.3.3.4" style="color: #3498DB; font-size: 22px; font-weight: bold;">
...
-   **SDXL's Solution:** During training, the model is explicitly conditioned on several metadata parameters in addition to the text prompt:
    -   `original_height` & `original_width`: The dimensions of the original image before any resizing or cropping.
    -   `crop_top` & `crop_left`: The coordinates of the top-left corner of the crop.
    -   `target_height` & `target_width`: The dimensions of the final generated image.
