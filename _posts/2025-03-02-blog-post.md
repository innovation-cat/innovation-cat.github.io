...
$$
\begin{align}
\frac{\partial \mathcal{L}}{\partial x_l} & = \frac{\partial \mathcal{L}}{\partial x_{l+1}} \cdot \frac{\partial x_{l+1}}{\partial x_{l}} = g_{l+1} \cdot J_{\rm LN}(x_l + f(x_l)) \cdot (I+J_{f}(x_l))\\[10pt]
& \approx (I + J_{f}(x_l)) \cdot \frac{1}{\sigma} \cdot g_{l+1}.
\end{align}
$$
