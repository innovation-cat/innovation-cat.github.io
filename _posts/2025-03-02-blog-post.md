...
$$
|g_0|*2 ;\lesssim; \Big(\prod*{\ell=1}^L |I+F'*\ell|*2\Big)
\Big(\prod*{\ell=1}^L \frac{1}{\sigma*\ell}\Big) |g_L|*2.
$$

So **the product of LN scalings $\prod (1/\sigma_\ell)$** can force vanishing or exploding gradients,
