...
<h1 id="section1.1" style="color: #1E3A8A; font-size: 24px; font-weight: bold; text-decoration: underline;">1.1 Gradient Flow, Conditioning, and Stability</h1>
...
<h1 id="section1.2" style="color: #1E3A8A; font-size: 24px; font-weight: bold; text-decoration: underline;">1.2 Balancing Capacity vs. Robustness</h1>
...
<h1 id="section1.3" style="color: #1E3A8A; font-size: 24px; font-weight: bold; text-decoration: underline;">1.3 Architecture–Noise Schedule Coupling</h1>
