...
$$
\begin{align}
\frac{\partial \mathcal{L}}{\partial x_l} & = \frac{\partial \mathcal{L}}{\partial x_{l+1}} \frac{\partial x_{l+1}}{\partial x_l} \\[10pt]
& = g_{l+1} (I+J_{f}({\rm LN}(x_l))\cdot J_{\rm LN}(x_l))
\end{align}
$$
