...
$$
J_{\rm LN}(x)\;=\;\frac{1}{\sigma}\left(H-\frac{1}{D}yy^\top\right)
...
$$
J_{\rm LN} \cdot \mathbf{1}=0\quad(\text{shift invariance}),\qquad J_{\rm LN} \cdot y=0\quad(\text{scale invariance}).
$$
...
$$
\|g_0\|_2 \;\approx\; \|g_L\|_2 \, \Big(\prod_{\ell=1}^L \|I+f'_\ell\|_2\Big)
\Big(\prod_{\ell=1}^L \frac{1}{\sigma_\ell}\Big) 
$$

So **the product of LN scalings $\prod (1/\sigma_\ell)$** can force vanishing or exploding gradients. Now, we analyze Pre-LN block 
