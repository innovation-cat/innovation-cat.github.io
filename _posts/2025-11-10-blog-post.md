...
From an optimization viewpoint, the latent-MAP formulation above is nothing more than a reparameterization of a **hard-constrained problem** in pixel space. Recall that the generator range
