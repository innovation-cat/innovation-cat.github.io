...
$$
\begin{align}
p(\mathbf{x_0}\mid \mathbf{y})\, & \propto\, p(\mathbf{y}\mid\mathbf{x_0})\,p(\mathbf{x_0}) \\[10pt]
\Longrightarrow \quad
\nabla_{\mathbf{x_0}}\log p(\mathbf{x_0}\mid\mathbf{y})
\,& =\, \underbrace{\nabla_{\mathbf{x_0}}\log p(\mathbf{y}\mid\mathbf{x_0})}_{\text{data consistency}}
+ \underbrace{\nabla_{\mathbf{x_0}}\log p(\mathbf{x_0})}_{\text{generative prior}}
\end{align}
$$
