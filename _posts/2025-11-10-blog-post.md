...
$$
\begin{align}
& \tilde{\mathbf{x}}_{t_k} \xleftarrow{\,\text{ODE Solver}\,} \mathbf{x}_{t_k} - \Delta_t\, v_{\text{prior}}(\mathbf{x}_t,t) \\[10pt]
& \mathbf{x}_{t_{k-1}} \xleftarrow{\,\text{DC Gradient Descent}\,} \tilde{\mathbf{x}}_{t_k} + \eta_k\,v_{\text{lik}}(\tilde{\mathbf{x}}_{t_k},t_k).
\end{align}
$$
