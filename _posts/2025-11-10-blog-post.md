...
### 5.3.1 From clean-space likelihood to noisy-space likelihood
...
$$
\begin{align}
& \tilde{\mathbf{x}}_{t_k} = \mathbf{x}_{t_k} - \Delta_t\, v_{\text{prior}}(\mathbf{x}_t,t) \\[10pt]
& \mathbf{x}_{t_k}^{\text{guided}} = \tilde{\mathbf{x}}_{t_k} + \eta_k,v_{\text{lik}}(\tilde{\mathbf{x}}_{t_k},t_k).
\end{align}
$$
