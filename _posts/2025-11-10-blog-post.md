...
- reducing the data consistency mismatch $$\|\mathbf{y}-A\mathbf{x}_0\|^2$$.

![Local Map Optimization](/images/posts/2025-11-10-blog-post/local_map.jpg)
...
<h1 id="section7" style="color: #1E3A8A; font-size: 27px; font-weight: bold; text-decoration: underline;">7. Conclusion and Outlook</h1>  
