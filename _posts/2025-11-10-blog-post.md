...
\hat{\mathbf{z}} & = \arg\min_{\mathbf{z}} \|\mathbf{y} - \mathbf{A}(\mathcal{G}(\mathbf{z}))\|_2^2 + \lambda R(\mathbf{z})
\end{align}
$$
...
Minimizing this is equivalent to minimizing $\|\mathbf{z}\|_2^2$. This leads to the most common and practical objective function for GAN-based inverse problems:
