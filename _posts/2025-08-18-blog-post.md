...
<details style="background:#f6f8fa; border:1px solid #e5e7eb; border-radius:10px; padding:.6rem .9rem; margin:1rem 0;">
  ...
  <ul>
	<li><a href="#section1">1. Introduction: Beyond Diffusion and Flows — Searching for the Third Path of Generation</a>
		<ul>
			<li><a href="#section1.1">1.1 The Ascendancy and Computational Bottlenecks of Diffusion Models</a></li>
			<li><a href="#section1.2">1.2 Continuous Normalizing Flows: Mathematical Elegance under Practical Constraints</a></li>
			<li><a href="#section1.3">1.3 The Turning Point: Directly Learning Paths Between Distributions</a></li>
		</ul>
	</li>
	...
	<li><a href="#section3">3. Foundations of the Flow Matching Paradigm</a>
		<ul>
			...
			<li><a href="#section3.4">3.4 Translating Perspectives — Bridging CNF, PF-ODE, and Flow Matching</a></li>
		</ul>
	</li>
	<li><a href="#section4">4. Conditional Flow Matching: Making the Objective Tractable</a></li>
	<li><a href="#section5">5. Flow Matching and Score Matching — Two Equivalent Views of Density Evolution</a></li>
	<li><a href="#section6">6. Rectified Flow: A Linear and Deterministic Implementation of Flow Matching</a></li>
	<li><a href="#section7">7. Stochastic Interpolants: A Unified Framework for Flows and Diffusions</a>
		<ul>
			...
			<li><a href="#section7.4">7.4 Connecting Stochastic Interpolants with Flow Matching and Diffusion Models</a>
				<ul>
					<li><a href="#section7.4.1">7.4.1 Comparing Flow Matching and Stochastic Interpolants</a></li>
					<li><a href="#section7.4.2">7.4.2 Comparing Stochastic Interpolants and Score-Based Diffusion Models</a></li>
				</ul>
			</li>
			<li><a href="#section7.5">7.5 The Conceptual and Practical Value of the Stochastic Interpolant Framework</a></li>
		</ul>
	</li>
...
<h1 id="section3.4" style="color: #1E40AF; font-size: 25px; font-weight: bold; text-decoration: underline;">3.4 Translating Perspectives: Bridging CNF, PF-ODE, and Flow Matching</h1>
...
<h1 id="section6" style="color: #1E3A8A; font-size: 27px; font-weight: bold; text-decoration: underline;">6. Special Case: Rectified Flow</h1>
