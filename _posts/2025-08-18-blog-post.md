...
In the previous article ([Diffusion Model Sampling: Towards Few-Step and One-step Generation](https://innovation-cat.github.io/posts/2025/05/diffusion-sampling/)), we traced the evolution of fast sampling techniques—from numerical acceleration by high-order ODE solvers, to model-level acceleration via distillation, and finally to training-level acceleration embodied by **Flow Matching**.
