...
For Gaussian conditional p_t(x\mid z)

$$
\begin{align}
v_t(x\mid z) & = \frac{dx}{dt} = \dot{s}(t)z+\dot{\sigma}(t)\frac{x-s(t)z}{\sigma(t)}  \\[10pt]
& = \frac{\dot{s}(t)}{s(t)}\,x + \frac{\dot{s}(t)}{s(t)}\,\left(- \frac{x-s(t)z}{\sigma^2(t)} \right) - \dot{\sigma}(t)\sigma(t)\,\left(- \frac{x-s(t)z}{\sigma^2(t)} \right) \\[10pt]
& = \frac{\dot{s}(t)}{s(t)}\,x
