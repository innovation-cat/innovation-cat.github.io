...
& = \sum_{m=0}^{p} \int_{0}^{h} e^{\,h-\tau}\,\frac{\tau^m}{m!}\,\epsilon^{(m)}_id\tau + \underbrace{\int_{0}^{h} e^{\,h-\tau}\,\frac{\tau^{p+1}}{(p+1)!}\,\epsilon^{(p+1)}_{\eta}d\tau}_{\text{Lagrange remainder}} \\[10pt]
& =  \sum_{m=0}^{p} h^{m+1}\epsilon^{(m)}_i\int_0^1 e^{\,h(1-\theta)}\,\frac{\theta^m}{m!}\,d\theta\, + h^{p+2}\epsilon^{(m)}_{\eta}\int_0^1 e^{\,h(1-\theta)}\,\frac{\theta^{p+1}}{(p+1)!}\,d\theta \\[10pt]
