...
Repeating the variation-of-constants steps in [§4.2](#section4.2) and changing variables from $t$ to log-SNR $\lambda=\log\frac{s}{\sigma}$ yields the exact one-step identity in the data-prediction view:
