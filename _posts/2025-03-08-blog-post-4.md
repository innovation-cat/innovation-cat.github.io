...
3. Approximating First-Order derivatives $$\epsilon'_{\theta}(x_{t_i}, t_i)$$ using Finite Differences 
   ...
   $$
   \epsilon'_{\theta}(x_{t_i}, t_i) \approx \frac{\epsilon_{\theta}(x_{t_s}, t_s)\,-\,\epsilon_{\theta}(x_{t_i}, t_i)}{\lambda_{t_s} - \lambda_{t_i}} = \frac{\epsilon_{\theta}(x_{t_s}, t_s)\,-\,\epsilon_{\theta}(x_{t_i}, t_i)}{rh}
   $$
