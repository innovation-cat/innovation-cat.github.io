...
\mathbf{D}_2 & = \epsilon_\theta(\tilde u_2,s_2)-\epsilon_\theta(\tilde x_{t_{i}},t_{i}) \\[10pt]
			...
			& \approx \mathcal{O}(h^3)+\left( \epsilon_\theta( u_2,s_2)-\epsilon_\theta(\tilde x_{t_{i}},t_{i}) \right)
...
& = \frac{1}{r_2}\left(\frac{e^{h}-1}{h}-1\right)(r_2h)\epsilon_{i}^{'} + \frac{1}{r_2}\left(\frac{e^{h}-1}{h}-1\right)\frac{(r_2h)^2}{2}\epsilon_{i}^{''} + \mathcal{O}(h^4)
\end{align}
$$
