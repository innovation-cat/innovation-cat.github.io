		...
		<ul>
			...
			<li><a href="#section4.2">4.2 DPM-Solvers</a>
				<ul>
				  ...
				  <li><a href="#section4.2.2">4.2.2 $\phi$-functions inside: From the integral to high-order updates</a></li>
				</ul>
			</li>
...
$$
x_t=s(t)x_0+\sigma(t)\varepsilon\,\rightarrow\,\frac{dx_t}{dt}=f(t)x_t-\frac{g^2(t)}{2}s_{\theta}(x_t, t)
$$



### <a id="section4.2.2">4.2.2 $\phi$-functions inside: From the integral to high-order updates</a>
