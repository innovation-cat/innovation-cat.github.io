...
Recall our discussion in [previous post](https://innovation-cat.github.io/posts/2024/11/diffusion-model-1/), for any discrete forward process, there exists a corresponding PF-ODE:
...
Such ODE is a first-order linear nonhomogeneous ODE. Solving PF-ODE using **variation of constants**, we get the exact one-step map over $\[t_{i-1}, t_{i}\]$
