...
$$
\begin{align}
\mathbf{LTE}_{DPM-Solver-1} & = x_{t_{i-1}} - \tilde x_{t_{i-1}} = \sigma(t_{i-1})\sum_{k=2}^{\infty}\left( h^k\varphi_k(h)\epsilon^{(k-1)}_{\theta}(x_{t_i}, t_i) \right) \\[10pt]
& = \sigma(t_{i-1})h^2\varphi_2(h)\epsilon^{'}_{\theta}(x_{t_i}, t_i) + \sigma(t_{i-1})\sum_{k=3}^{\infty}\left( h^k\varphi_k(h)\epsilon^{(k-1)}_{\theta}(x_{t_i}, t_i) \right) \\[10pt]
...
$$
\begin{align}
\mathbf{LTE}_{DPM-Solver-2} & = x_{t_{i-1}} - \tilde x_{t_{i-1}} = \sigma(t_{i-1})\sum_{k=2}^{\infty}\left( h^k\varphi_k(h)\epsilon^{(k-1)}_{\theta}(x_{t_i}, t_i) \right) \\[10pt]
& = \sigma(t_{i-1})h^2\varphi_2(h)\left( \frac{\epsilon_{\theta}(x_{t_s}, t_s)- \epsilon_{\theta}(\tilde x_{t_s}, t_s)}{rh} + \sigma(t_{i-1})\sum_{k=3}^{\infty}\left( h^k\varphi_k(h)\epsilon^{(k-1)}_{\theta}(x_{t_i}, t_i) \right) \\[10pt]
& = \sigma(t_{i-1})h^2\varphi_2(h)\left( \frac{\mathcal{O}\|\tilde x_{t_s} - x_{t_s}\|}{rh} + \sigma(t_{i-1})\sum_{k=3}^{\infty}\left( h^k\varphi_k(h)\epsilon^{(k-1)}_{\theta}(x_{t_i}, t_i) \right) \\[10pt]
& = \sigma(t_{i-1})h^2\varphi_2(h)\left( \frac{\mathcal{O}(h^2)}{rh} + \sigma(t_{i-1})\sum_{k=3}^{\infty}\left( h^k\varphi_k(h)\epsilon^{(k-1)}_{\theta}(x_{t_i}, t_i) \right) \\[10pt]
& = \mathcal{O}(h^3)
\end{align}
$$
