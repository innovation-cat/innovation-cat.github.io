...
- **Step 1:** Train the model with real data samples $x_1 \sim p_{\text{data}}$. This anchors the velocity field to the true data manifold.
...
A natural concern is: *if synthetic endpoints are poor quality or off-manifold, wouldn’t the model drift further away from real data?* ReFlow avoids this problem through two safeguards:
...
2. **Straight-path supervision is independent of endpoint quality**
   ...
   * This “rectification” objective simplifies the geometry of the velocity field, making trajectories straighter, regardless of endpoint realism.
