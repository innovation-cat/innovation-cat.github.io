...
<h1 id="section1" style="color: #1E3A8A; font-size: 27px; font-weight: bold; text-decoration: underline;">1. Introduction: FM Can Be Faster Than Diffusion-Based PF-ODEs</h1>
...
![straight-line path and  ODE trajectories](/images/posts/2025-07-02-blog-post/pair_line.jpg)


However, given this sample dataset, the obtained ODE trajectory is curved, as shown in the following figure.

![straight-line path and  ODE trajectories](/images/posts/2025-07-02-blog-post/average_vector_field.jpg)
