...
<details style="background:#f6f8fa; border:1px solid #e5e7eb; border-radius:10px; padding:.6rem .9rem; margin:1rem 0;">
  ...
  <ul>
	<li><a href="#section1">1. Introduction: FM Faster Than Diffusion-Based PF-ODEs</a>
		<ul>
	...
	<li><a href="#section2">2. RF Bottleneck: Straight but Not Instantaneous</a>
		<ul>
			<li><a href="#section2.1">2.1 Mathematical View</a></li>
		</ul>
	</li>
	<li><a href="#section3">3. Reflow: iteratively training makes the path straighter</a>
		<ul>
			<li><a href="#section3.1">3.1 Improving the Training: One Reflow is Sufficient</a></li>
		</ul>
	</li>
	<li><a href="#section4">4. InstaFlow: Text-Conditioned Rectified Flow with One-Step Distillation</a>
		<ul>
	...
	<li><a href="#section5">5. Shortcut Model: Few-Step Generation via Step-Conditioned</a>
		<ul>
	...
	<li><a href="#section6">6. MeanFlow: Learning Mean Velocity Fields for One-Step Generation</a>
		<ul>
