...
$$
x_t = s(t)x_1+\sigma(t)\epsilon = s(t)x_1+\sigma(t)x_0, \quad x_0 \sim \mathcal{N}(0,I)
$$ 

> **Takeaway.** It is noted that this formula is identical to the forward process of the diffusion model. Therefore, the probability path defined in flow matching is equivalent to the forward noising in the diffusion model.
