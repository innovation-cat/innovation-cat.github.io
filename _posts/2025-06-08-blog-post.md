...
\Longrightarrow 
& \mathcal L_{FM}(\theta)=\mathbb E_{\scriptscriptstyle  t\sim U(0,1), z\sim p_{data}(z), x_t\sim p_t(x_t|z)}\big(\| v_{\theta}(t, x_t) \|^2 -2\| v_{\theta}(t, x_t) \| \| u_t(x_t) \| + \| u_t(x_t) \|^2 \big) \quad  \\[10pt] 
