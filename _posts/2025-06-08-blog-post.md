...
$$
\begin{align}
\frac{d}{dt}\,\mathbb{E}\big[\varphi(Y_t)\big]
= \mathbb{E}\big[\nabla\varphi(Y_t)\cdot \dot Y_t\big]
= \mathbb{E}\big[\nabla\varphi(Y_t)\cdot u_t(Y_t)\big]
= \int \nabla\varphi(x)\cdot\big(\mu_t(x)u_t(x)\big)\,dx
= -\int \varphi(x)\,\nabla\!\cdot\!\big(\mu_t u_t\big)\,dx.
\end{align}
$$
