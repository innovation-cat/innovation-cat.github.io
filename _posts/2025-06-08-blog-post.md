...
Let's denote $p_0$ as the initial distribution, $p_1$ as the target distribution, SI defines the probability path connecting two distributions through a general class of interpolating functions. At a high level, SI specifies a mapping
