...
$$
\begin{align}
\qquad & \mathcal L_{FM}(\theta)=\mathbb E_{t\sim U(0,1), x_t\sim p_t(x_t)}\| v_{\theta}(t, x_t) - v_t(x_t) \|^2\label{eq:31} \\[10pt]
\Longrightarrow \qquad 
...
\Longrightarrow \qquad & \mathcal L_{FM}(\theta)=\mathbb E_{t\sim U(0,1), z\sim p_{data}(z), x_t\sim p_t(x_t|z)}\| v_{\theta}(t, x_t) - v_t(x_t|z) \|^2  +C_1+C_2\label{eq:34}  \\[10pt] 
\Longrightarrow \qquad 
