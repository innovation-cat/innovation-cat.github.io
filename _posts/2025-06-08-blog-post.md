...
The first step of SI is to define a probability path $\{p_t\}_{t \sim \[0,1\]}$ that connects two endpoint distributions. Formally, let
...
$$
X_t \;=\; \Phi\!\left(t,\; X_0,\; X_1,\; \zeta\right),\qquad t\in[0,1],
$$
...
## <a id="section6.2">6.2 Deterministic Path (ODE)</a>


---


## <a id="section6.3">6.3 Stochastic Path (SDE)</a>

---

## <a id="section6.4">6.4 Diffusion, RF, and FM as Mutual Special Cases</a>
