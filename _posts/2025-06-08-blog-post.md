...
$$
\mathcal{L}_{\text{FM}}(\theta) = \mathbb{E}_{t \sim \mathcal{U}[0,1],\, x_t \sim p_t,\, x_1 \sim p_1,\, x_0 \sim p_0} \big[\, \| v_\theta(x_t, t) - v_t(x_t|x_0,x_1) \|^2 \,\big]\label{eq:18}
$$

---

# <a id="section4.3">4.3 Extension: Conditional Flow Matching</a>

While Flow Matching provides a general regression framework, optimizing the target function shown in Equation \ref{eq:18} is very difficult, as the true target is intractable. 
