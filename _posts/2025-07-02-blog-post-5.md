...
$$
\mathcal L_{FM}(\theta)=\mathbb E_{t\sim U(0,1), x_t\sim p_t(x_t)}\big|\big| u_t^{\theta}(x_t) - u_t(x_t) \big|\big|^2
$$
...
$$
\frac{dx_t}{dt}=u_t(x_t) \ \Longleftrightarrow \ x_t \sim p_t(x_t) \ \ (0 \leq t \leq 1)
$$
...
$$
\mathcal L_{CFM}(\theta)=\big|\big| u_t^{\theta}(x_t) - u_t(x_t|z) \big|\big|^2
$$
...
$$
\frac{dx_t}{dt}=u_t(x_t\|z) \ \Longleftrightarrow \ x_t \sim p_t(x_t|z) \ \ (0 \leq t \leq 1)
$$
...
$$
u_t(x_t)=\int u_t(x_t|z)*p(z|x_t)dz=\int u_t(x_t|z)*\frac{p_t(x_t|z)p_{data}(z)}{p(x_t)}dz
$$
...
$$
\begin{align}
& \mathcal L_{FM}(\theta)=\mathbb E_{t\sim U(0,1), x_t\sim p_t(x_t)}\big|\big| u_t^{\theta}(x_t) - u_t(x_t) \big|\big|^2 \\ \Longrightarrow \ \ 
& \mathcal L_{FM}(\theta)=\mathbb E_{t\sim U(0,1), x_t\sim p_t(x_t)}\big|\big| u_t^{\theta}(x_t) \big|\big|^2 -2*\mathbb E_{t\sim U(0,1), x_t\sim p_t(x_t)}\big|\big| u_t^{\theta}(x_t) \big|\big|*\big|\big| u_t(x_t) \big|\big| + \mathbb E_{t\sim U(0,1), x_t\sim p_t(x_t)} \big|\big| u_t(x_t) \big|\big|^2
\end{align}
$$
...
$$
\begin{align}
& \mathbb E_{t\sim U(0,1), x_t\sim p_t(x_t)}\big(\big|\big| u_t^{\theta}(x_t) \big|\big|*\big|\big| u_t(x_t) \big|\big| \big)  \\ \Longrightarrow \ \ 
& \int_t\int_{x_t} p_t(x_t)*\big|\big| u_t^{\theta}(x_t) \big|\big|*\big|\big| u_t(x_t) \big|\big|dx_tdt  \\ \Longrightarrow \ \ 
& \int_t\int_{x_t} p_t(x_t)*\big|\big| u_t^{\theta}(x_t) \big|\big|* \big( \int_z\big|\big| u_t(x_t|z) \big|\big|*\frac{p_t(x_t|z)p_{data}(z)}{p(x_t)}dz \big) dx_tdt   \\ \Longrightarrow \ \ 
&  \int_t\int_{x_t}\int_z p_t(x_t)*\frac{p_t(x_t|z)p_{data}(z)}{p(x_t)}*\big|\big| u_t^{\theta}(x_t) \big|\big|*\big|\big| u_t(x_t|z) \big|\big|dzdx_tdt   \\ \Longrightarrow \ \ 
& \int_t\int_{x_t}\int_z p_t(x_t|z)*p_{data}(z)*\big|\big| u_t^{\theta}(x_t) \big|\big|*\big|\big| u_t(x_t|z) \big|\big|dzdx_tdt   \\ \Longrightarrow \ \ 
&  \mathbb E_{t\sim U(0,1), z\sim p_{data}(z), x_t\sim p_t(x_t|z)}\big(\big|\big| u_t^{\theta}(x_t) \big|\big|*\big|\big| u_t(x_t|z) \big|\big| \big)
\end{align}
$$
...
\begin{align}
& \mathcal L_{FM}(\theta)=\mathbb E_{t\sim U(0,1), x_t\sim p_t(x_t)}\big|\big| u_t^{\theta}(x_t) - u_t(x_t) \big|\big|^2 \\ \Longrightarrow \ \ 
& \mathcal L_{FM}(\theta)=\mathbb E_{t\sim U(0,1), x_t\sim p_t(x_t)}\big|\big| u_t^{\theta}(x_t) \big|\big|^2 -2*\mathbb E_{t\sim U(0,1), x_t\sim p_t(x_t)}\big|\big| u_t^{\theta}(x_t) \big|\big|*\big|\big| u_t(x_t) \big|\big| + \mathbb E_{t\sim U(0,1), x_t\sim p_t(x_t)} \big|\big| u_t(x_t) \big|\big|^2  \\ \Longrightarrow \ \ 
& \mathcal L_{FM}(\theta)=\mathbb E_{t\sim U(0,1), z\sim p_{data}(z), x_t\sim p_t(x_t|z)}\big|\big| u_t^{\theta}(x_t) \big|\big|^2 -2*\mathbb E_{t\sim U(0,1), z\sim p_{data}(z), x_t\sim p_t(x_t|z)}\big|\big| u_t^{\theta}(x_t) \big|\big|*\big|\big| u_t(x_t|z) \big|\big| + \mathbb E_{t\sim U(0,1), z\sim p_{data}(z), x_t\sim p_t(x_t|z)}\big|\big| u_t(x_t|z) \big|\big|^2 +C_1+C_2 \\ \Longrightarrow \ \ 
& \mathcal L_{FM}(\theta)=\mathbb E_{t\sim U(0,1), z\sim p_{data}(z), x_t\sim p_t(x_t|z)}\big|\big| u_t^{\theta}(x_t) - u_t(x_t|z) \big|\big|^2  +C_1+C_2  \\ \Longrightarrow \ \ 
& \mathcal L_{FM} = \mathcal L_{CFM}+C
\end{align}
$$
