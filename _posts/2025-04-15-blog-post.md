...
Since we have obtained an unbiased estimate of the score, substituting \ref{eq:ct_unbias} into Eq. \ref{eq:next} to get the estimate of the next point.

$$
\hat{x}_{t_{n-1}} = x_{t_n} + \int_{t_n}{t_{n-1}} 
$$
