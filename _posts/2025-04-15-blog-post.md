...
We do not know the true marginal probability density $p_t(x_t)$, so we cannot obtain the score directly. However, for a given $x_0 \in p_{\text{data}}$, under the general Gaussian perturbation
