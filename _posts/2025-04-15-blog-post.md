...
- **Step 2: Taylor expansion of the CD update.** take taylor expansion of the metric $d$ in its second argument
  
  $$
  d(x, y+\Delta) = d(x, y) + \partial_2 d(x, y)\cdot \Delta + o(\Delta)
  $$
  
  where $$\partial_2$$ means the gradient of the function $d$ with respect to its second argument. Consider the loss function of CD.
