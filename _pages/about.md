...
<p><img align="right" src="../images/trust.png" alt="Photo" style="width: 130px; border-radius: 10px; padding: 10px 10px 10px 10px">In recent years, I work on the mathematical foundations of Deep Learning, where the ultimate goal is to build trustworthy and safety AI. Tradition AI approaches are rely heavily on the availability of large-scale and high-quality data but do not provide a mechanism for securely obtaining and using these data. This motivate us to seek for a new training paradigm, which enables multiple devices collaboratively to train a shared model without compromising data privacy and security. More research results can be found in <a href="https://innovation-cat.github.io/publications/">Publications</a>.</p>
